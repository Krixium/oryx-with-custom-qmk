...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_PAUSE,       KC_PSCR,        KC_DELETE,      KC_INSERT,      KC_TRANSPARENT,                                 KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, KC_RIGHT_CTRL,  
    KC_TRANSPARENT, LSFT(KC_F11),   KC_TRANSPARENT, LCTL(KC_GRAVE), LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),                                   KC_HOME,        KC_PGDN,        KC_PAGE_UP,     KC_END,         KC_TRANSPARENT, KC_RIGHT_SHIFT, 
